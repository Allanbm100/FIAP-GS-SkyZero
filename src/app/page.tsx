    ...
    <>
      ...
      <section className="relative h-[538px] w-full">
        ...
        <div className="flex flex-col justify-center items-center gap-2 pt-[160px]">
          <h1 className="text-5xl font-bold text-center text-white">POR UM FUTURO</h1>
          <h1 className="text-5xl font-bold text-center text-white">MAIS VERDE</h1>
      ...
      <section className="flex flex-col items-center gap-5 py-20">
        ...
        <ul className="flex flex-col xl:flex-row gap-4">
          <li>
            <div className="flex flex-col items-center gap-2 sm:w-80 lg:w-96 py-2 border-2 rounded-xl border-[#079b11]">
          ...
          <li>
            <div className="flex flex-col items-center gap-2 sm:w-80 lg:w-96 py-2 border-2 rounded-xl border-[#079b11]">
              ...
              <p className="text-gray-500">Registro de voos em seu perfil</p>
            </div>
          </li>
          <li>
            <div className="flex flex-col items-center gap-2 sm:w-80 lg:w-96 py-2 border-2 rounded-xl border-[#079b11]">
        ...
        <div className="flex flex-col items-center gap-10 lg:flex-row xl:gap-12 2xl:gap-16">
          ...
          { name: "Levi Magni", rm: "RM98276", img: fotoLevi, github: "https://github.com/levmn" }].map((member, index) => (
            <article key={index} className="flex flex-col items-center gap-2">
              <Image src={member.img} alt={`Foto do ${member.name}`} className="border-4 border-[#079b11] rounded-full w-60 h-60" />
              <div className="flex flex-col items-center">
